...
```{r}
#example.pedigree.df
knitr::kable(example.pedigree.df, format = "markdown", digits = 2)
...
#penetrance.df
knitr::kable(penetrance.df, format = "markdown", digits = 2)
...
knitr::kable(ord.df.current, format = "markdown", digits = 2)
...
knitr::kable(ord.df.max, format = "markdown", digits = 2)
```
