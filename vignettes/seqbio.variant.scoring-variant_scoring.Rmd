...
vignette: >
  %\VignetteIndexEntry{seqbio.variant.scoring-variant_scoring}
...
ex.score.sum <- score.fam(rel.mat, full.df.status, return.sums = TRUE, return.means = FALSE)
ex.score.sum
``` 
...
ex.score.table <- score.fam(rel.mat, full.df.status, return.sums = FALSE, return.means = FALSE)
ex.score.table
``` 
## How scoring works 
